const TermsAndCondition = () => {
  return (
    <section>
      <div className="flex flex-col items-center justify-center px-5 md:px-10 overflow-hidden">
        {/* Title Container */}
        <div className="flex h-auto min-w-[100vw] flex-col items-center justify-end bg-[#f2f2f7] py-6 md:h-64">
          <div className="flex flex-col items-center gap-y-4 py-5">
            ...
            <p className="text-sm text-[#808080] sm:text-base">
              Last Updated as of July 14, 2024
            </p>
          </div>
        </div>
        {/* Content Container */}
              ...
              <div className="flex flex-col gap-y-10">
                <div className="flex min-w-full flex-col items-start gap-y-6">
                  <div className="flex flex-col items-start gap-y-3">
                    ...
                    <p className="text-sm">
                      Flowspark offers a comprehensive range of design services,
                  ...
                  <div className="flex flex-col items-start gap-y-3">
                    ...
                    <p className="text-sm">
                      ...
                      acknowledges that the Companys liability is limited to
